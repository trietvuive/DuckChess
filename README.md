...
You can use any chess UI that knows how to talk to engine with UCI. I use en-croissant, Chessifier (now [Pawn Appetit](https://github.com/Pawn-Appetit/pawn-appetit)) works as well. Lichess integration soon...
